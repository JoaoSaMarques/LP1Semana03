...
namespace RoPaSci
{
    class Program
    {
        ...
        {
            GameItem player1Item = Enum.Parse<GameItem>(args[0]);
            GameItem player2Item = Enum.Parse<GameItem>(args[1]);
            GameStatus result = RockPaperScissors(player1Item, player2Item);
